  ...
  return (
    <div
      className={`glass-panel overflow-hidden transition-all border ${
        isHighRisk
          ? 'border-rose-500/40 bg-gradient-to-b from-rose-50/50 via-white to-white dark:from-rose-950/20 dark:via-slate-900 dark:to-slate-900'
    ...
    >
      ...
      <div
        ...
        className="p-5 flex flex-wrap items-center justify-between gap-4 cursor-pointer hover:bg-slate-100/60 dark:hover:bg-slate-800/40 transition-colors"
      >
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-2 text-lg font-bold text-slate-900 dark:text-white capitalize">
            <span className="px-3 py-1 rounded-lg bg-slate-100 dark:bg-slate-800 text-sky-700 dark:text-sky-300 border border-slate-200 dark:border-slate-700">
              {pair.medicine_a}
            </span>
      ...
      {/* Expanded Content */}
      {isExpanded && (
        <div className="px-5 pb-5 pt-2 border-t border-slate-200 dark:border-slate-800/80 space-y-4 text-sm">
          {/* Interaction Title */}
          <div>
          ...
          {pair.urgent_warning && (
            <div className="bg-rose-50 dark:bg-rose-950/50 p-4 rounded-xl border border-rose-300 dark:border-rose-500/40 text-rose-900 dark:text-rose-200 flex items-start gap-3 text-xs shadow-inner">
              <AlertOctagon className="w-5 h-5 text-rose-600 dark:text-rose-400 shrink-0 mt-0.5" />
              <div>
                <span className="font-bold text-rose-700 dark:text-rose-300 block text-sm mb-1 uppercase tracking-wide">
          ...
          <div className="pt-2 flex items-center justify-between border-t border-slate-200 dark:border-slate-800/60">
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-sky-700 dark:text-sky-300 text-xs font-medium transition-colors border border-slate-200 dark:border-slate-700"
            >
