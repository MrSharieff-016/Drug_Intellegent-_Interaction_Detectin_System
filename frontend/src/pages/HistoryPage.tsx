    ...
    return (
      <div className="space-y-6 animate-fade-in pb-12">
        ...
        <div className="glass-panel p-6 border-slate-800 flex items-center justify-between">
          <div>
            <span className="text-xs text-slate-400 font-mono">Analysis ID: {selectedDetail.analysis_id}</span>
            <h3 className="text-xl font-bold text-white flex items-center gap-3 mt-1">
    ...
    <div className="space-y-6 animate-fade-in pb-12">
      <div className="glass-panel p-6 border-slate-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-xl font-bold text-white">Past Medication Analysis Audits</h2>
      ...
      {loading ? (
        ...
        <div className="glass-panel p-12 text-center text-slate-400 space-y-3 border-slate-800">
        ...
        <div className="grid grid-cols-1 gap-4">
          {historyItems.map((item) => (
            <div
              ...
              className="glass-panel p-5 border-slate-800 hover:border-sky-500/40 cursor-pointer transition-all flex flex-wrap items-center justify-between gap-4 group"
            >
              <div className="space-y-1.5">
                ...
                <div className="flex flex-wrap items-center gap-1.5 pt-1">
                  ...
                  {item.medications.map((med, mIdx) => (
                    <span
                      key={mIdx}
                      className="px-2.5 py-0.5 rounded-lg bg-slate-800 text-sky-300 text-xs font-medium border border-slate-700 capitalize"
                    >
                      {med}
                    </span>
                  ))}
